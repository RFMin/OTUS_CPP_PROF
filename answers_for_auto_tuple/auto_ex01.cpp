...
int main(int argc, char *argv[]) {
  ...
  //  func4(i); // 4.1. param type ?            //  will not compile
  //  func4(ci); // 4.2. param type ?           //  will not compile
  // func4(cir); // 4.3. param type ?           //  will not compile
  // func4(42); // 4.4. param type ?            //  will not compile
  // func4(pi); // 4.5. param type ?            //  will not compile
  // func4(cpi); // 4.6. param type ?           //  will not compile
  return 0;
}