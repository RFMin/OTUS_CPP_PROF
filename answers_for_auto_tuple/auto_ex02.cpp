...
int main(int argc, char* argv[]) {
  {
    ...
    //  auto& v2 = func_value();        // 1.2 - v2 type ?  //  compilation error
  ...
  }
  {
    ...
    const auto& v3 = func_ref();  // 2.3 - v3 type ?        int&
    auto&& v4 = func_ref();       // 2.4 - v4 type ?        int&
  }
  {
    auto v1 = func_cref();         // 3.1 - v1 type ?       int
    auto& v2 = func_cref();        // 3.2 - v2 type ?       int&
    const auto& v3 = func_cref();  // 3.3 - v3 type ?       int&
    auto&& v4 = func_cref();       // 3.4 - v4 type ?       int&
  }
  {
    auto v1 = func_ptr();         // 4.1 - v1 type ?        int*
    //  auto& v2 = func_ptr();        // 4.2 - v2 type ?    //  compilation error
  ...
  }
  {
    ...
    auto&& v4 = func_cptr();       // 5.4 - v4 type ?       int*&&
  }
  {
  ...
  }
  {
    ...
    auto v4 = {10};         // 8.4 - v4 type ?              int
    auto v5 = {1, 2, 3};    // 8.5 - v5 type ?              int
    //  auto v6 = {1, 2, 3.0};  // 8.6 - v6 type ?          //  compilation error
